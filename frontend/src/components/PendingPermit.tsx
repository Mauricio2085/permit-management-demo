...
const PendingPermit = () => {
  ...
  const {
    ...
    loading: loadingPendingPermissionToDownload,
    error: errorPendingPermissionToDownload,
  } = useFetch<PermissionDownloadResponse>(
    `${URL_API}/work-at-heights/pending-complete-permissions/${permissionId}`
  );

  if (loadingPendingPermissionToDownload) return <Loading />;

  if (errorPendingPermissionToDownload) {
    return (
      <ErrorModal
        isOpen={true}
        onClose={() => {
  ...
  const pendingPermissionToDownloadData =
    pendingPermissionToDownload?.data || [];
  const documentsSupportWithAnswers =
    pendingPermissionToDownloadData[0].documentsSupport;
  const itemsCheckWithAnswers =
    pendingPermissionToDownloadData[0].answersCheckPermission;
  const signaturesExecutorsPermission =
    pendingPermissionToDownloadData[0].signaturesPermission.filter(
    ...
    switch (activeTab) {
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-gray-900 mt-1">
                    {pendingPermissionToDownloadData[0].customer}
                  </p>
                </div>
                <div>
                  <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                  ...
                  <p className="text-sm text-gray-900 mt-1">
                    {new Date(
                      pendingPermissionToDownloadData[0].permissionStartDate
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900 mt-1">
                    {pendingPermissionToDownloadData[0].description}
                  </p>
                </div>
                <div>
                  <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                  ...
                  <p className="text-sm text-gray-900 mt-1 font-bold">
                    {pendingPermissionToDownloadData[0].sequence}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  const isSelected =
                    pendingPermissionToDownloadData[0].criticalTasks?.includes(
                      task
                    );
                  return (
                    <div
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-blue-50 rounded">
                  ...
                  <p className="text-lg font-bold text-blue-600">
                    {parseInt(
                      pendingPermissionToDownloadData[0].maxHeightAuthorized
                    )}
                    m
                  </p>
                </div>
                <div className="text-center p-3 bg-green-50 rounded">
                  ...
                  <p className="text-lg font-bold text-green-600">
                    {parseInt(
                      pendingPermissionToDownloadData[0].maxLoadAuthorized
                    )}
                    Kg
                  </p>
                </div>
      ...
      case "equipos":
        return (
          <div className="space-y-4">
            <EquipmentCard
              items={pendingPermissionToDownloadData[0].fallElements}
      ...
      case "proteccion":
        return (
          <div className="space-y-4">
            <EquipmentCard
              items={
                pendingPermissionToDownloadData[0].personalProtectionElements
              }
      ...
      case "acceso":
        return (
          <div className="space-y-4">
            <EquipmentCard
              items={pendingPermissionToDownloadData[0].accessElements}
  ...
  return (
    <>
      <h1 className="text-xl font-bold mt-20 mb-4 px-4 md:px-0">
        Revise el permiso antes de descargarlo!
      </h1>

      <PermissionDownloadPdfButton
        type={"pending"}
        data={pendingPermissionToDownloadData[0]}
      />
        ...
        <div className="grid grid-cols-3 gap-2 justify-items-center border-x border-b border-black p-2 mb-4">
          <div className="flex flex-row items-center gap-2">
            ...
            <div className="w-6 h-6 border border-black mr-auto ml-5 items-center flex justify-center text-[12px] font-bold">
              {pendingPermissionToDownloadData[0].criticalTasks?.map(
                (critical) => {
        ...
        <div className="flex items-center mb-4">
          <div className="flex items-center w-1/2 justify-center">
            ...
            <div className="border-b border-black h-6 w-10 ml-3 text-center font-bold">
              {parseInt(pendingPermissionToDownloadData[0].maxHeightAuthorized)}
            </div>
          ...
          <div className="flex items-center w-1/2 justify-center">
            ...
            <div className="border-b border-black h-6 w-10 ml-3 text-center font-bold">
              {parseInt(pendingPermissionToDownloadData[0].maxLoadAuthorized)}
            </div>
          ...
          <tbody>
            <tr>
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].fallElements.map(
                  (fallElement) =>
        ...
        <table className="w-full border-collapse text-xs mb-4">
          ...
          <tbody>
            <tr>
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].personalProtectionElements.map(
        ...
        <table className="w-full border-collapse text-xs mb-6">
          ...
          <tbody>
            <tr>
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].accessElements.map(
                  (accessElement) => (accessElement === "Extintores" ? "X" : "")
                )}
              </td>
              <td className="w-60 h-6 border border-black p-1 text-left">
                Kit ambiental
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].accessElements.map(
                  (accessElement) =>
                    accessElement === "Escaleras tipo tijera" ? "X" : ""
                )}
              </td>
              <td className="w-60 h-6 border border-black p-1 text-left">
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].accessElements.map(
                  (accessElement) =>
                    accessElement === "Elementos para delimitación" ? "X" : ""
                )}
              </td>
            </tr>
            <tr>
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].accessElements.map(
                  (accessElement) =>
                    accessElement === "Escalera extensibles" ? "X" : ""
                )}
              </td>
              <td className="w-60 h-6 border border-black p-1 text-left">
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].accessElements.map(
                  (accessElement) =>
                    accessElement === "Elementos de señalizacion" ? "X" : ""
                )}
              </td>
              <td className="w-60 h-6 border border-black p-1 text-left">
                Detector de gases
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].accessElements.map(
                  (accessElement) =>
                    accessElement === "Detector de gases" ? "X" : ""
                )}
              </td>
            </tr>
            <tr>
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].accessElements.map(
                  (accessElement) =>
                    accessElement === "Escaleras fijas" ? "X" : ""
                )}
              </td>
              <td className="w-60 h-6 border border-black p-1 text-left">
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].accessElements.map(
                  (accessElement) =>
                    accessElement === "Equipos de Comunicación" ? "X" : ""
                )}
              </td>
              <td className="w-60 h-6 border border-black p-1 text-left">
                Andamios
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].accessElements.map(
                  (accessElement) => (accessElement === "Andamios" ? "X" : "")
                )}
              </td>
              <td className="w-60 h-6 border border-black p-1 text-left">
                Elevadores
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].accessElements.map(
                  (accessElement) => (accessElement === "Elevadores" ? "X" : "")
                )}
              </td>
            </tr>
            <tr>
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].accessElements.map(
                  (accessElement) => (accessElement === "Botiquín" ? "X" : "")
                )}
              </td>
              <td className="w-60 h-6 border border-black p-1 text-left">
                Grúas con canasta
              ...
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
                {pendingPermissionToDownloadData[0].accessElements.map(
                  (accessElement) =>
                    accessElement === "Gruas con canasta" ? "X" : ""
                )}
              </td>
              <td className="w-60 h-6 border border-black p-1 text-left"></td>
              <td className="w-8 h-6 border border-black p-1 text-center font-bold">
